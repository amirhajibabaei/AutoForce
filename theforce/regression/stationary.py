...
class Stationary(Kernel):
    ...
    @property
    def state_args(self):
        return "signal={}, lengthscale={}".format(
            self.signal.data, self.lengthscale.data
        )
    ...
    def get_k(self, r):
        ...
        raise NotImplementedError("get_k in {}".format(self.__class__.__name__))

    def get_dk(self, r):
        raise NotImplementedError("get_dk in {}".format(self.__class__.__name__))

    def get_d2k(self, r):
        raise NotImplementedError("get_d2k in {}".format(self.__class__.__name__))
